    ...
    Column(
        ...
        Column(
            ...
            SettingsCard(title = "Scope") {
                ...
                SettingValueRow(
                    title = "Saved content",
                    description = "Profile UUID/name, capture mode, preferred frame source, AWB, curves, color, sharpness, SPECTRA/noise, JPEG, frame-selection and multi-frame settings.",
                    value = ".bnc",
                    onClick = {}
                )
                SettingValueRow(
