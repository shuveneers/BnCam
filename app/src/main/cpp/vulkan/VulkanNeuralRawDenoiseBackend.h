...
struct NeuralVulkanModelIdentity {
 bool ready=false;
 Sha256Digest packageSha{};
 Sha256Digest sourceModelSha{};
 Sha256Digest packedWeightsSha{};
 float residualKSigma=0.0f;
 std::uint32_t innerTile=0u;
 std::uint32_t halo=0u;
};
...
public:
 ...
 NeuralVulkanModelIdentity modelIdentity() const noexcept;
private:
