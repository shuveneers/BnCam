...
class PhysicalLumaDeviceTest {
    @Test fun physicalLumaCpuAndProductionGpuPreserveDetail() {
        ...
        val report = ImageUtils.validatePhysicalLumaNative()
        File(context.filesDir, "physical_luma_validation.txt").writeText(report)
